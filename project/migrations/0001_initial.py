    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_fields', models.ManyToManyField(blank=True, related_name='server_custom_fields', to='project.customfield')),
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='server_projects', to='project.project')),
            ],
        ),
    ]
