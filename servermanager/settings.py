...
SECRET_KEY = 'django-insecure-1npil10ruxkk+37my*zl9kld#m_mqyg^&==zkmo5#r(!t5rd-g'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '0.0.0.0', 'cameronmckay.xyz']
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'servermanager.validators.SpecialCharacterCheckValidator',
        'OPTIONS': {
            'char_count': 1,
        }
    }
